...
Swift Member LineUp is currently under active development.
...
If you discover a security vulnerability in Swift Member LineUp, please **do not open a public issue**.
...
- The Swift Member LineUp CLI
- Build and distribution artifacts
- Configuration handling (`.swift-member-lineup.yaml`)
...
Thank you for helping keep Swift Member LineUp secure.
